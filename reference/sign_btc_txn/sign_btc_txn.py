...
# user runeks - https://bitcoin.stackexchange.com/users/902/runeks

#bitcointools
from bitcointools import deserialize, bc_address_to_hash_160
from base58 import b58decode, public_key_to_bc_address, hash_160_to_bc_address
...
tx_info = deserialize.parse_Transaction(stream)
